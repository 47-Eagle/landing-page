import{i as v,d as f,x as a}from"./ethers.BAccFBXb.js";import{c as u,n as w,r as d,o as q,U as ve}from"./index.CjEp_J4M.js";import{w as fe,p as ge,s as be,l as ye,M as g,m as se,R as l,r as P,n as K,e as ce,k as le,g as m,c as Y,h as xe,o as S,E as ie,O as E,C as F,q as oe,i as T,A as H,T as Ce,t as ke,a as Se,f as We}from"./core.B_O5aNFq.js";import"./three-vendor.Cl_v6tw3.js";import"./motion.D77LWkhN.js";import"./react-vendor.CxNYRydI.js";import"./safe-vendor.CAyK0Plv.js";import"./viem.Zt6ufg3v.js";import"./index.es.CHqj4FkG.js";import"./wallet-ui.DrX7agi0.js";const p=ge({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ye(p,()=>r(p))},subscribeKey(r,e){return be(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
